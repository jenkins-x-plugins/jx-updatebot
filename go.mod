...
require (
	...
	github.com/jenkins-x-plugins/jx-gitops v0.10.9
	github.com/jenkins-x-plugins/jx-pipeline v0.5.16
	github.com/jenkins-x-plugins/jx-promote v0.6.3
...
require (
	...
	github.com/GoogleContainerTools/kpt v0.37.1 // indirect
...
replace (
	...
	github.com/jenkins-x/go-scm => github.com/jenkins-x/go-scm v1.11.29
