...
require (
	...
	github.com/jenkins-x/jx-helpers/v3 v3.0.120
	github.com/jenkins-x/jx-logging/v3 v3.0.6
	github.com/jenkins-x/lighthouse-client v0.0.182
...
replace (
	...
	github.com/jenkins-x/go-scm => github.com/jenkins-x/go-scm v1.9.2
