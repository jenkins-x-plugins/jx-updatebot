...
export JENKINS_X_URL='https://dashboard-jx.infra.jenkins-x.rocks/jenkins-x-plugins/jx-updatebot/main/12'
...
export MINK_IMAGE='ghcr.io/jenkins-x/jx-updatebot:0.3.8'
