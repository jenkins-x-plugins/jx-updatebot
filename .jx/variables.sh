...
export JENKINS_X_URL='https://dashboard-jx.infra.jenkins-x.rocks/jenkins-x-plugins/jx-updatebot/main/26'
...
export MINK_IMAGE='ghcr.io/jenkins-x/jx-updatebot:0.8.22'
